...
% new approach -- using configuration in and out the function 
% when to use: when we need to use multiple similar variable in several functions
% how to use: define: ** cfg.yourvariablename = yourvariablename ** in main
%             unpack: ** yourvariablename = cfg.yourvariablename ** in each function
...
%% ===================== 9) per-subject per-bin refit and big plot ================
