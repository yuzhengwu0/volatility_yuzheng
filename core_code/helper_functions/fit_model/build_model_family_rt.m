...
% model family to RT:
% fixed terms: accuracy (C), coherence (coh), vol condition (z_cond)
% M0: baseline + C + coh + z_cond
% M1: baseline + C + coh + z_cond + P
% M2: baseline + C + coh + z_cond + V
% M3: baseline + C + coh + z_cond + P + V
% M4: baseline + C + coh + z_cond + P + V + P*V
% M5: baseline + C + coh + z_cond + P + V + C*V
% M6: baseline + C + coh + z_cond + P + V + P*V*coh
% M7: baseline + C + coh + z_cond + P + V + C*V*coh

baseLabels    = {'b0 (Intercept)','b_{corr}','b_{coh}','b_{cond}'};
